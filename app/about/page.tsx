        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            {values.map((value) => (
              <div
                key={value.title}
                className="group relative rounded-2xl bg-card p-8 border border-border/70 shadow-[0_14px_40px_-30px_rgba(15,74,60,0.45)] text-center transition-all duration-300 hover:shadow-[0_24px_60px_-32px_rgba(15,74,60,0.55)] hover:border-accent/60 hover:-translate-y-1 cursor-pointer"
              >
