...
export function ServiceCard({ title, description, icon: Icon }: ServiceCardProps) {
  return (
    <div className="group relative rounded-2xl bg-card p-6 border border-border/70 shadow-[0_12px_35px_-28px_rgba(15,74,60,0.4)] transition-all duration-300 hover:shadow-[0_22px_55px_-30px_rgba(15,74,60,0.5)] hover:border-accent/60 hover:-translate-y-1 cursor-pointer">
