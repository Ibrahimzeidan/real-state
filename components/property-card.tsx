...
export function PropertyCard({
  ...
  return (
    <Link href={`/projects/${id}`} className="group block cursor-pointer">
      <div className="relative overflow-hidden rounded-2xl bg-card border border-border/70 shadow-[0_12px_35px_-28px_rgba(15,74,60,0.4)] transition-all duration-300 hover:shadow-[0_22px_55px_-30px_rgba(15,74,60,0.5)] hover:border-accent/60 hover:-translate-y-1">
