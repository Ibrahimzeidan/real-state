...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="relative h-screen min-h-[700px] flex items-center">
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(80% 60% at 20% 20%, rgba(226,199,127,0.4), transparent 60%), linear-gradient(110deg, rgba(199,163,106,0.95), rgba(199,163,106,0.75), rgba(199,163,106,0.25))",
            }}
          />
        </div>
      ...
      <section className="py-20 lg:py-28 bg-[#1C2A3A] text-[#F6F1E8]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <span className="text-sm font-semibold text-accent uppercase tracking-wider">Why Choose Us</span>
              <h2 className="mt-2 font-serif text-3xl font-bold text-[#F6F1E8] sm:text-4xl">
                Your Trusted Partner in Real Estate
              </h2>
              <p className="mt-4 text-[#F6F1E8]/80 leading-relaxed">
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3 text-[#F6F1E8]/90">
