      ...
      <section className="py-20 lg:py-28 lux-section relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            {/* Contact Form */}
            <div className="group relative rounded-2xl bg-card p-8 border border-border/70 shadow-[0_18px_50px_-35px_rgba(199,163,106,0.45)]">
            ...
            <div>
              ...
              {/* Map Placeholder */}
              <div className="mt-10 aspect-video rounded-2xl bg-secondary/70 border border-border/70 flex items-center justify-center overflow-hidden group cursor-pointer transition-all duration-300 hover:border-accent/60 shadow-[0_12px_35px_-28px_rgba(199,163,106,0.35)]">
